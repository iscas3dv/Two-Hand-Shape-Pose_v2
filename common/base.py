...
# The class Trainer is modified to load pre-trained InterNet model.
...
class Trainer(Base):
    ...
    def get_optimizer(self, model):
        optimizer = torch.optim.Adam(model.module.mesh_reg.parameters(), lr=cfg.lr)
        return optimizer
    ...
    def _make_model(self):
        ...
        if cfg.continue_train:
            ...
            start_epoch = 0
        model.train()
        # model.module.heatmap_predictor.eval()
        print("make heatmap predictor fixed")
